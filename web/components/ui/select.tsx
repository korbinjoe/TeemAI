...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      ...
      'bg-bg-input px-3 py-1 text-xs text-text-primary',
      'placeholder:text-text-muted',
      'focus:outline-none focus:ring-1 focus:ring-accent-brand',
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      'data-[highlighted]:bg-bg-hover data-[highlighted]:text-text-emphasis',
      'data-[highlighted]:outline-none data-[highlighted]:ring-0',
      'focus:bg-bg-hover focus:text-text-emphasis',
