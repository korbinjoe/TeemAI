/**
 * ClaudeACPAdapter -  Claude Code CLI (stream-json)  ACP
 *
 * Claude Code CLI  ACP
...
const log = createLogger('ClaudeACPAdapter')

const PROMPT_TIMEOUT_MS = 10 * 60 * 1000

export interface ClaudeACPAdapterOptions {
  command: string
  baseArgs: string[]
  env?: Record<string, string>
}

export class ClaudeACPAdapter extends EventEmitter implements ACPAgentAdapter {
  ...
  constructor(
    ...
    private options: ClaudeACPAdapterOptions,
  ) {
    super()
