...
const buildAgentsOnlyPrompt = (description: string): string =>
  [
    ...
    '4. IMPORTANT: ALL output MUST be written in English regardless of the input language. Even if the description below is in Chinese or another language, your output must be entirely in English.',
    '',
