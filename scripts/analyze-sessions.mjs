...
function extractKeywords(sessions) {
  const keywords = {}
  const patterns = [
    [/bug|fix|修复|修|问题/i, 'Bug fix'],
    [/refactor|重构/i, 'Refactor'],
    [/性能|performance|perf|优化/i, 'Performance'],
    [/terminal|终端|xterm|pty/i, 'Terminal'],
    [/websocket|ws|连接/i, 'WebSocket'],
    [/session|会话/i, 'Session mgmt'],
    [/test|测试/i, 'Testing'],
    [/方案|设计|design/i, 'Design'],
    [/review|审查|检查/i, 'Code review'],
    [/commit|提交|git/i, 'Git ops'],
    [/deploy|部署|发布/i, 'Deploy'],
    [/UI|样式|style|css|tailwind/i, 'UI/Style'],
    [/分析|analyze|report/i, 'Analysis'],
    [/electron/i, 'Electron'],
